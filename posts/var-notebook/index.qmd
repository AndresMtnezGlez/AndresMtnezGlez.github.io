---
title: "A Notebook on VAR Models: Wold Representation, Impulse Response Functions and Identification"
description: "Lecture-style notes deriving the vector moving average (Wold) representation of a VAR, structural identification via Cholesky decomposition, and impulse response functions, with worked examples in R using the vars package."
author: "Andrés Martínez González"
date: "2020-11-13"
categories: [VAR, time series, macroeconometrics, impulse response, R]
format:
  html:
    toc: true
    toc-depth: 3
